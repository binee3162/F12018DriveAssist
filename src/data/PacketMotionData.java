...
public class PacketMotionData extends Packet {
	...
	public void demo() {//todo: modify
		...
		assert(carMotionData!=null);
		speed=sumSquareRoot(carMotionData.getWorldVelocityX(),carMotionData.getWorldVelocityY(),carMotionData.getWorldVelocityZ());
		//log.println("Speed:"+speed);


	}
	public float sumSquareRoot(float x,float y,float z){
